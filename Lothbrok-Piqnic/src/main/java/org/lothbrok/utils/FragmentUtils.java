...
public class FragmentUtils {
    ...
    public static void upload(String path) throws IOException {
        ...
        for(ICharacteristicSet family : families) {
            ...
            HDT newHdt;
            try {
                newHdt = HDTManager.generateHDT(new FragmentGeneratorIterator(triples), "http://piqnic.org/fragments#" + id, new HDTSpecification(), null);
            } catch (Exception e) {
                continue;
            }
            ...
            AbstractNode.getState().addNewFragment(id, id, outpath, family);
        }
    }
