...
//    @Override
//    public long estimateJoinCardinality(StarString star, List<String> vars, long boundCount) {
...
//    @Override
//    public long estimateJoinCardinality(StarString star, List<String> vars, long boundCount, IGraph fragment) {
//        if (boundCount == 0) return 0;
//        boolean subjBound = (!star.getSubject().equals("") && !star.getSubject().toString().startsWith("?"));
//        boolean subjBoundVar = !subjBound && vars.contains(star.getSubject().toString());
//
