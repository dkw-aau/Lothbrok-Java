...
public class StarPatternElementParserForJena extends StarPatternElementParser<RDFNode,String,String> {
    private static StarPatternElementParserForJena instance = null;

    /**
     *
     * @return
     */
    public static StarPatternElementParserForJena getInstance()
    {
        if ( instance == null ) {
            instance = new StarPatternElementParserForJena();
        }
        return instance;
    }
     ...
     *
     */
    protected StarPatternElementParserForJena() {}
