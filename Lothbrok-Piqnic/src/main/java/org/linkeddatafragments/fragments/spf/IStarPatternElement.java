...
public interface IStarPatternElement<ConstantTermType,NamedVarType,AnonVarType> {
    /**
    ...
    /**
     * Returns true if this element is an unspecified variable, and false if it is
     * not an unspecified variable.
     *
     * If this element is a specific variable denoted by a blank node (that is,
     * this method returns true), the blank node can be obtained by the method
     * {@link #asAnonymousVariable()}.
     ...
     *         if {@link #isAnonymousVariable()} returns false).
     */
    String asUnspecifiedVariable() throws UnsupportedOperationException;
}
