package org.piqnic.piqnic.standalone;

import org.piqnic.piqnic.servlet.ExperimentsServlet;
import org.piqnic.piqnic.servlet.NodeApiServlet;
import org.piqnic.piqnic.servlet.WebInterfaceServlet;
...
public class JettyServer {
    private static void printHelp(Options options) {
        ...
        formatter.printHelp("java -jar target/piqnic.jar [config-example.json] [<options>]",
                    "Starts a standalone Piqnic node. Options:", options, "");
    }
