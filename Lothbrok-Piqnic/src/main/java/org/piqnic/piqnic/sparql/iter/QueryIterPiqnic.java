...
import org.piqnic.piqnic.sparql.exceptions.QueryInterruptedException;
...
public class QueryIterPiqnic extends QueryIterRepeatApply {
    ...
    public QueryIterPiqnic(QueryIterator input, Triple pattern, ExecutionContext cxt, Set<IGraph> fragments) {
        super(input, cxt);
    ...
    static class BindMapper extends QueryIter {
        ...
        BindMapper(PiqnicBindings bindings, Triple pattern, ExecutionContext cxt, Set<IGraph> fragments) {
            super(cxt);
