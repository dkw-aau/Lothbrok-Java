...
import org.piqnic.piqnic.sparql.PiqnicTurtleEventHandler;
...
public class RemotePiqnicIterator extends NiceIterator<Pair<Triple, Binding>> {
    private String currUrl = null;
    private final Triple triple;
    private final PiqnicBindings bindings;
    private Queue<Pair<Triple, Binding>> results = new LinkedList<>();
    private Pair<Triple, Binding> next = null;

    public RemotePiqnicIterator(String startUrl, Triple triple, PiqnicBindings bindings) {
    ...
    private void parseNext() {
        ...
        PiqnicTurtleEventHandler handler = new PiqnicTurtleEventHandler(currUrl);
    ...
    private Queue<Pair<Triple, Binding>> extendBindings(PiqnicBindings bindings, Triple tp, List<Triple> triples) {
