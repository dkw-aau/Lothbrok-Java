...
public class LocalPiqnicIterator extends NiceIterator<Pair<Triple, Binding>> {
    ...
    public LocalPiqnicIterator(Triple triple, PiqnicBindings bindings, HDT datasource) {
        ...
        if(it.hasNext()) {
            ...
            try {
                iterator = datasource.search(
                        this.triple.getSubject().isVariable() ? "" : (this.triple.getSubject().isBlank()? this.triple.getSubject().getBlankNodeLabel() : this.triple.getSubject().getURI()),
    ...
    private class IteratorTriple implements Iterator<Triple> {
        ...
        public IteratorTriple(Triple triple, PiqnicBindings bindings) {
            this.triple = triple;
