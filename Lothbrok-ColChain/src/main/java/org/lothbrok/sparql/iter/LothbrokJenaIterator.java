...
public class LothbrokJenaIterator extends NiceIterator<Pair<Triple, Binding>> {
    ...
    public LothbrokJenaIterator(Queue<NiceIterator<Pair<Triple, Binding>>> iterators) {
